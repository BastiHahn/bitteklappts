    ...
    <section className="about_me" ref={aboutSection} id="überMich">
      <div className="grid-container container">
        <div className="grid-item item1">
          ...
          <h3 className="grid_h3" ref={headAbout2}>
            Peter Bischof
          </h3>
        ...
        <div className="grid-item item3">
          <div className="nested-grid">
            {certificates.map((cert, index) => (
              <div className="thecard nested-item" key={index}>
                <div className="front_card">
                  <h5>{cert.title}</h5>
                </div>
                <div className="back-card">
                  <div className="back-card_logo">
                    {cert.id === 1 ? (
                      cert.logo
                    ) : (
                      <img className="cert_logo_img" src={cert.logo}></img>
                    )}
                  </div>
                </div>
